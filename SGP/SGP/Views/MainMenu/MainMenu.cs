...
using SGP.Views;
using SGP.Views.Administradores;
using SGP.Views.Logs;
using SGP.Views.Paciente;
using SGP.Views.Procedimento;
using SGP.Views.Registros;
using System;
    ...
    public partial class frmMainMenu : Form
    {
        ...
        private void backupToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string destdir = "C:\\DBBackup\\DB_SGP " + DateTime.Now.ToString("dd-MM-yyyy_HH-mm-ss") + ".bak";
                cc.con = new SqlConnection(cs.DBConn);
                cc.con.Open();
                string cb = "backup database [" + System.Windows.Forms.Application.StartupPath + "\\DB_SGP.mdf] to disk='" + destdir + "'with init,stats=10";
        ...
        private void restoreToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (openFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    cc.con = new SqlConnection(cs.DBConn);
                    cc.con.Open();
                    string cb = "USE Master ALTER DATABASE [" + System.Windows.Forms.Application.StartupPath + "\\DB_SGP.mdf] SET Single_User WITH Rollback Immediate Restore database [" + System.Windows.Forms.Application.StartupPath + "\\DB_SGP.mdf] FROM disk='" + openFileDialog1.FileName + "' WITH REPLACE ALTER DATABASE [" + System.Windows.Forms.Application.StartupPath + "\\DB_SGP.mdf] SET Multi_User ";
                    cc.cmd = new SqlCommand(cb);
                    cc.cmd.Connection = cc.con;
                    cc.cmd.ExecuteReader();
                    cc.con.Close();
        ...
        {
            st1 = lblUser.Text;
            st2 = "Logout realizado com sucesso";
            cf.LogFunc(st1, System.DateTime.Now, st2);
            this.Hide();
