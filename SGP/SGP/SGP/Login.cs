    ...
    public partial class frmLogin : Form
    {
        ...
        private void btnLogar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cc.cmd.CommandText = "SELECT RTRIM(UserName),RTRIM(UserSenha) FROM Registration WHERE UserName = @d1 and UserSenha=@d2";
                ...
                if (cc.rdr.Read())
                {
                    ...
                    cc.con.Open();
                    cc.cmd = cc.con.CreateCommand();
                    cc.cmd.CommandText = "SELECT UserTipo, UserID FROM Registration WHERE UserName=@d3 and UserSenha=@d4";
